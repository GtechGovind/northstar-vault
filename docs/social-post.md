...
Attach `northstar-social-preview.png` (or the 90-second demo video made from `demo-script.md`) and publish this text from the user's LinkedIn account only after explicit approval.
...
- user-isolated Firestore histories and deny-by-default rules
- Gemini on Vertex AI through a keyless Cloud Run service identity
...
- Screenshot or demo video is attached.
